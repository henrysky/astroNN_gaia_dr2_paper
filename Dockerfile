...
RUN git clone https://github.com/henrysky/astroNN_gaia_dr2_paper.git
WORKDIR /workspace/astroNN_gaia_dr2_paper
RUN pip install -r requirements.txt
RUN mkdir data_files figs
RUN curl --cookie zenodo-cookies.txt "https://zenodo.org/records/13308879/files/gaia_dr2_train.h5?download=1" --output gaia_dr2_train.h5
RUN curl --cookie zenodo-cookies.txt "https://zenodo.org/records/13308879/files/gaia_dr2_test.h5?download=1" --output gaia_dr2_test.h5
